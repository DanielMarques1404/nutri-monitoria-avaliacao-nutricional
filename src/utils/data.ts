...
export const data: QuizQuestion[] = [
  {
    ...
    options: [
      {
        id: "A",
        text: "Correta, porque o peso isolado já define a classificação nutricional",
      },
      {
        id: "B",
        text: "Incorreta, porque a classificação depende do IMC, e o IMC depende da relação entre peso e altura",
      },
      {
        id: "C",
        text: "Correta apenas se a gestante estiver no primeiro trimestre",
      },
    ],
    correctOptionId: "B",
    explanation:
  ...
  },
  {
    ...
    options: [
      {
        id: "A",
        text: "Usar 63,4 kg e 1,62 m, porque são os dados da consulta atual",
      },
      {
        id: "B",
        text: "Usar 58 kg e 1,62 m, porque o IMC pré-gravídico deve refletir o estado nutricional antes da gestação",
      },
      {
        id: "C",
        text: "Fazer a média entre 58 kg e 63,4 kg para evitar erro de subestimação",
      },
    ],
    correctOptionId: "B",
    explanation:
  ...
  },
  {
    ...
    options: [
      {
        id: "A",
        text: "Porque ele substitui toda a avaliação do ganho de peso ao longo da gestação",
      },
      {
        id: "B",
        text: "Porque ele ajuda a identificar o estado nutricional antes da gestação e serve como base para acompanhar a evolução ponderal depois",
      },
      {
        id: "C",
        text: "Porque ele é calculado com o peso do dia da consulta e mostra o estado nutricional do trimestre atual",
      },
    ],
    correctOptionId: "B",
    explanation:
  ...
  },
  {
    ...
    options: [
      {
        id: "A",
        text: "O arredondamento para uma casa decimal é aceitável e a classificação continua sendo eutrofia",
      },
      {
        id: "B",
        text: "O arredondamento invalida a classificação, então o caso fica sem resposta",
      },
      {
        id: "C",
        text: "O valor deve ser automaticamente arredondado para 22 kg/m²",
      },
    ],
    correctOptionId: "A",
    explanation:
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "Usou a fórmula do IMC com altura em centímetros" },
      { id: "B", text: "Não elevou a altura ao quadrado" },
      { id: "C", text: "Arredondou o resultado antes de terminar a conta" },
    ],
    correctOptionId: "B",
    explanation:
  ...
  },
  {
    ...
    options: [
      {
        id: "A",
        text: "O cálculo está certo, mas a classificação está errada",
      },
      {
        id: "B",
        text: "O cálculo está errado, mas a classificação está certa",
      },
      { id: "C", text: "Tanto o cálculo quanto a classificação estão errados" },
    ],
    correctOptionId: "A",
    explanation:
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "30,1 kg/m² — obesidade" },
      { id: "B", text: "31,6 kg/m² — obesidade" },
      { id: "C", text: "26,8 kg/m² — sobrepeso" },
    ],
    correctOptionId: "A",
    explanation:
  ...
  },
  {
    ...
    options: [
      { id: "A", text: "IMC 18,4 kg/m² — baixo peso" },
      { id: "B", text: "IMC 18,4 kg/m² — eutrofia" },
      { id: "C", text: "IMC 19,4 kg/m² — eutrofia" },
    ],
    correctOptionId: "C",
    explanation:
